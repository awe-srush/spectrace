"""System prompt for RFC rule extraction."""

EXTRACTION_SYSTEM_PROMPT = """\
You are extracting structured conformance rules from an RFC section.

For each MUST, MUST NOT, SHOULD, SHOULD NOT, SHALL, SHALL NOT, REQUIRED, or \
RECOMMENDED statement in the RFC text, produce one NormalizedRule JSON object.
...
Output ONLY a JSON array of NormalizedRule objects. No preamble, no explanation, no markdown code fences.\
"""
